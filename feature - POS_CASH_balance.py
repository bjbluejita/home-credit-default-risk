...
@Package 
@author: ly
@date Date: 2019年04月04日 15:14
@Description: 
@URL: https://github.com/oskird/Kaggle-Home-Credit-Default-Risk-Solution/blob/master/Feature/feature%20-%20POS_CASH_balance.py
@version: V1.0
'''
import pandas as pd
...
pcb_prev_count = POS_CASH_balance.groupby( 'SK_ID_CURR' )['SK_ID_PREV'].count()
...
print( 'POS_CASH_balance process finished!' )