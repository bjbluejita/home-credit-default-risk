...
@Package 
@author: ly
@date Date: 2019年04月15日 10:09
@Description: 
@URL: https://github.com/oskird/Kaggle-Home-Credit-Default-Risk-Solution/blob/master/Feature/feature%20-%20clustering.py
@version: V1.0
'''
import numpy as np
import pandas as pd
...
bureau['DEBT_TOTAL_EATIO'] = bureau.AMT_CREDIT_SUM_DEBT / ( bureau.AMT_CREDIT_SUM + 1 )
...
cluter_bur = bureau[ ['SK_ID_BUREAU', 'CREDIT_DAY_OVERDUE', 'OVERDUE_DEBT_RATIO', 'DEBT_TOTAL_EATIO', 'CNT_CREDIT_PROLONG']].merge( bur_max_bad_level, on='SK_ID_BUREAU', how='left' ).fillna(0)
